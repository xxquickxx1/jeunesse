    ...
    $('#page_images').on('mouseenter mouseleave', 'li', function(e) {
      ...
      if (e.type == 'mouseenter') {
        if (image_actions.length == 0) {
          ...
          var img_delete = $("<img src='/assets/refinery/icons/delete-6fab9310cb7ca270fca3eb99395659c9fa4d673cec260aecd2c964ba7e4bcc68.png' width='16' height='16' />");
          ...
          if ($this.find('textarea.page_caption').length > 0) {
            var img_caption = $("<img src='/assets/refinery/icons/user_comment-b812ae9617c513096bfc9687c586d3ef9946cc83cfb4585cf8789785c1b16722.png' width='16' height='16' class='caption' />");
